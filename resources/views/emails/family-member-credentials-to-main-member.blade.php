...
<head>
    ...
    <title>{{ __('messages.user_family_member_credentials_subject') }}</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background-color:#ffffff;border:1px solid #E6EBF4;border-radius:16px;overflow:hidden;">
                    <tr>
                        <td style="background-color:#080D21;padding:24px 28px;">
                            ...
                            <h1 style="margin:8px 0 0;font-size:22px;line-height:1.3;color:#E6EBF4;">{{ __('messages.user_family_member_credentials_heading') }}</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:28px;">
                            <p style="margin:0 0 16px;font-size:16px;line-height:1.6;color:#0F141E;">
                                {{ __('messages.user_family_member_credentials_greeting', ['name' => $mainMember->fullName()]) }}
                            </p>
                            <p style="margin:0 0 16px;font-size:15px;line-height:1.6;color:#0F141E;">
                                {{ __('messages.user_family_member_credentials_intro', ['member' => $familyMember->fullName()]) }}
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin:0 0 20px;background-color:#E6EBF4;border-radius:12px;">
                                <tr>
                                    <td style="padding:18px 20px;">
                                        ...
                                        <p style="margin:0 0 16px;font-size:15px;color:#0F141E;">{{ $familyMember->roleLabelWithShortForm() }}</p>
                                        ...
                                        <p style="margin:0 0 16px;font-size:15px;color:#0F141E;">{{ $familyMember->username }}</p>
                            ...
                            <p style="margin:0 0 20px;font-size:14px;line-height:1.6;color:#0F141E;">
                                {{ __('messages.user_family_member_credentials_share_hint') }}
                            </p>
